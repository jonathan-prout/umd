...
class atom:
	def __init__(self,id,status,servicename,aspectratio,ebno,pol,bissstatus,vresol,framerate,vstate,asioutmode,inSatSetupModType,inSatSetupRollOff,inSatSetupSymbolRate,inSatSetupSatelliteFreq,inSatSetupFecRate,inSatSetupInputSelect,inSatSetupSatelliteFreq2,inSatSetupSymbolRate2,input_selection):
		self.id = id
		self.status = status
...
# JP Changes
	...
	def setinSatSetupModType(self,inSatSetupModType):
                #print inSatSetupModType
		if (inSatSetupModType == "2"):
			self.inSatSetupModType = "DVB-S"
		if (inSatSetupModType == "7"):
			self.inSatSetupModType = "DVB-S2"
                if (inSatSetupModType == "5"):
                        self.inSatSetupModType = "AUTO"
